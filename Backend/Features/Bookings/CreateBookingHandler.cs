...
public class CreateBookingHandler(ApplicationContext dbContext, IMapper mapper, CreateBookingValidator validator) : IRequestHandler<CreateBookingRequest, IResult>
{
